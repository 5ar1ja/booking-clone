...
ALLOWED_HOSTS = config("BOOKING_ALLOWED_HOSTS", default="localhost,127.0.0.1", cast=Csv())
DEBUG = config("BOOKING_DEBUG", default=False, cast=bool)
EMAIL_BACKEND = config(
    "BOOKING_MAIL_BACKEND",
...
#
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=config("ACCESS_TOKEN_LIFETIME", cast=int, default=240)),
